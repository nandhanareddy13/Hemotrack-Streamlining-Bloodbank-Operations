...
<head>
    <title>HemoTrack | Blood Required </title>
    <!-- Meta tag Keywords -->
                ...
                <div class="container px-5"><center>
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="d-flex space-d-flex">
                            ...
                            <div class="form-group grid-inputs">
                                <label for="recipient-name" class="col-form-label">Age Group</label>
                                <select  class="form-control" id="phone" name="brf">
                                    <option value="">Blood Required For</option>
                                    <option value="18">below 18 years</option>
                                    <option value="30">18 - 30 years</option>
                                    <option value="60">30 - 60 years</option>
                                    <option value="oldage">60 + years</option>
                                    </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="5" cols="10" class="form-control" id="message" name="message" placeholder="Please enter your message" maxlength="999" style="resize:none"></textarea>
                        </div>
                        <div class="form-group">
    <input type="submit" value="Send Message" name="send" style="background-color: red; color: #fff;">
</div>
