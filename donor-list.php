...
<head>
	<title>HemoTrack | Blood Donor List </title>
	<!-- Meta tag Keywords -->
...
<a class="btn btn-primary" style="color:#fff; margin-bottom: 40px;" href="contact-blood.php?cid=<?php echo $result->id;?>">Request</a>
